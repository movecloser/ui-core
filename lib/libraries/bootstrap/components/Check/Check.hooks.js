...
const useBootstrapCheck = (props, ctx, validClassMap = composables_1.defaultValidationClassMap) => {
    ...
    const component = composition_api_1.computed(() => multiple.value ? bootstrap_vue_1.BFormCheckboxGroup : bootstrap_vue_1.BFormRadioGroup);
