...
exports.BootstrapInput = composition_api_1.defineComponent({
    ...
    setup(props, ctx) {
        ...
        const { sizeClass, validationClass, value: _model } = abstract_1.useInputControl(props, ctx, Input_config_1.bootstrapInputSizeRegistry, composables_1.defaultValidationClassMap, props.type === 'number' && props.castAsNumber);
        /**
