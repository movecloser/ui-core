...
import { AbstractNavItemProps, AbstractNavItemTag, UseNavItemProvides } from './NavItem.contracts'
 ...
 * @author Stanisław Gregor <stanislaw.gregor@movecloser.pl>
 */
export const useNavItem = (props: AbstractNavItemProps): UseNavItemProvides => {
  /**
